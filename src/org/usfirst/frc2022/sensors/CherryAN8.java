 ...
 * functions are accessible using the CherryAN8 class
 * 
* @param channel - The PWM channel on the default module where the sensor is
 * connected (minimum)
 */
public class CherryAN8 implements PIDSource {
     ...
     *
     * This constructor assumes the minimum voltage possible is .5 volts, and
     * the max voltage possible is 4.5 volts If that is not the case then call
     * setMinVoltage() and setMaxVoltage() to change those values
     *
     * This constructor also believes that the offset for the sensor is 0, if
     * that is not the case then call the other constructor.
     *
     * @param channel - The PWM channel on the default module where the sensor
     * is connected
     */
     ...
     * @param channel - The PWM channel on the default module where the sensor
     * is connected
     * @param offset - The angle the sensor is off from 0, can be anywhere
     * between PI and -PI if in Radians 180 and -180 if in degrees
     * @param offsetIsRadians - Boolean value saying if the offset parameter is
     * in radians
     */
     ...
     * @param channel - The PWM channel on the module where the sensor is
     * connected
     */
     ...
     *
     * @param offset - a value representing the offset of the sensor, can be
     * readians or degrees (set boolean accordingly)
     * @param isRadians - a boolean value saying whether the inputed value is
     * radians or degrees
     */
    ...
    /**
     * Function to set the maximum voltage of the sensor This function will call
     * the computeVoltsPerRadian function to adjust for the new voltage.
     *
     * @param maxVoltage - The maximum voltage possible on the sensor, any
     * voltage read higher than this is ignored
     */
    ...
    /**
     * Function to set the minimum voltage of the sensor This function will call
     * the computeVoltsPerRadian function to adjust for the new voltage.
     *
     * @param minVoltage - The minimum voltage possible on the sensor, any
     * voltage read lower than this is ignored
     */
    ...
    /**
     * Function to compute the voltage per radian for the sensor. This function
     * should be called anytime a change is made to the minVoltage value or the
     * maxVoltage value
     *
     */
     ...
     * Function to return the current angle of the sensor
     *
     * @param isRadians - Whether the output should be in radians, Radians if
     * true, Degrees if false
     * @return The current angle of the sensor in whichever measurement is
     * specified
     */
    ...
    /**
     * Function to return the current voltage of the sensor No adjustments are
     * made to the voltage in this function, this is the raw voltage.
     *
