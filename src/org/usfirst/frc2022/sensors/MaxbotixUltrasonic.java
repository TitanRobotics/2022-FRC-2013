...
//PWH
/**
* This is for making the Maxbotix Ultrasound stuff work!
* It's good.
*/
public class MaxbotixUltrasonic extends SensorBase {
 AnalogChannel channel;
	...
	*/
	...
	/**
	* Get the raw voltage from the sensor.
	* If you're using this, you're doing it wrong.
	*/
    double GetVoltage() {
