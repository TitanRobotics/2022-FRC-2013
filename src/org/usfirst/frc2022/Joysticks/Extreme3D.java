...
/**
 * Interfaces with an Extreme3D joystick. This class was designed to allow
 * better definition of the joysticks in the source code of a program since the
 * class will be named with the joystick type and the function calls will return
 * what is expect.
 *
 * The Joystick class is an interface with the Drivers Station to get the input
 * from the joystick.
 *
...
public class Extreme3D extends Joystick {
    ...
    /**
     * Get the value of the Twist for the joystick. The right side of the axis
     * is positive.
     *
     * @param
